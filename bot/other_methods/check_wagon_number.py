...
def get_wagon_type(number):
    number_type = {2: 'крытые вагоны', 3: 'прочие(специализированные) вагоны', 4: 'платформы', 6: 'полувагоны', 7: 'цистерны', 8: 'изотермические вагоны', 9: 'прочие(специализированные) вагоны', 5: 'приватные'}
    return number_type.get(int(number[0]))